        ...
        <div className="row py-4 mr-1 text-center">
          ...
          <div className="col-xl-4 col-lg-4 col-md-4 col-sm-12 scroll-y-hidden">
            <div className="float-right">
              {" "}
              <span className="text-white">sadadas</span>
              <a
                className="carousel-control-next w-auto font-xs px-3 right-xs text-dark border   "
                href="#podCastCarousel"
                role="button"
                data-slide="next"
              >
              ...
              <a
                className="carousel-control-next w-auto font-xs   right-sm px-3 text-dark border "
                href="#podCastCarousel"
                role="button"
                data-slide="prev"
              >
        ...
        <div className="row">
          <div className="col-xl-12 col-lg-12 col-md-12 col-sm-12">
            <div className="row my-3 mx-1">
              <div
                id="podCastCarousel"
                className="carousel podCastCarousel slide w-100"
                data-ride="carousel"
              >
                    ...
                    <div className="col-md-4">
                      <div className="card">
                        ...
                        <div className="card-img-overlay img-overlay-light pl-md-5 pl-1 pt-md-5">
                          ...
                          <h3 className="card-text pb-3 scroll-y-hidden">
                            Week 5 Fantasy
                            <br /> Projections + Notes
                          </h3>

                          <a href="">
                            <span className="align-bottom more-link text-dark">
                              More
                            </span>
                          </a>
                          <br />
                    ...
                    <div className="col-md-4">
                      <div className="card">
                        ...
                        <div className="card-img-overlay img-overlay-blue-gradient text-white pl-md-5 pl-1 pt-md-5">
                          ...
                          <a href="">
                            <span className="align-bottom more-link ">
                              More
                            </span>
                          </a>
                          <br />
